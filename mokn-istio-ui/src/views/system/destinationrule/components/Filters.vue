   ...
   <!--查询过滤条件部分-->
    <el-col :span="24" class="toolbar" style="padding-top:10px;">
        <el-form :inline="true" :model="filters" ref="filtersForm" size="small">
          ...
          <el-form-item>
            <el-button type="primary" @click="getDestinationRules" icon="el-icon-search" >查询</el-button>
          </el-form-item>
          <el-form-item>
            <el-button @click="resetFilters({destinationrules:''})" icon="el-icon-zoom-in">清空</el-button>
          </el-form-item>
        </el-form>
        </el-col>
  </section>
...
<script>
  ...
  export default{
    ...
    methods: {
      //导入store actions
      ...mapActions(['getDestinationRules', 'resetFilters']),
      getNamespaces() {
              let param={
              };
